...
<div class="prefix_2 grid_8">
  <div class="titulo">Reporte de Entrada de Productos</div>
    ...
    <table class="tablareg">
       <tr>
           ...
           <select name="codproducto">
            ...
            <td>Desde Fecha de Entrada:<br>
               <input type="date" name="desdefechaentrada" required value="<?php echo date("Y-m-d")?>"></td>
           <td>
           <td>Hasta Fecha de Entrada:<br>
               <input type="date" name="hastafechaentrada" required value="<?php echo date("Y-m-d")?>"></td>
           <td>
